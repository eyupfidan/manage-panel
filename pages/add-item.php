...
if($_GET['logout'])
{
   ...
   $get_category = $conn->query("SELECT * FROM ib_category WHERE state = 1", PDO::FETCH_ASSOC);
   ?>
<!doctype html>
<html lang="en">
   <head>
      ...
      <title>Ürün Ekle | itembag.net</title>
               ...
               <div class="col-md-8" style="
                  ...
                  <div class="main-card mb-3 card">
                     <div class="card-body">
                        ...
                        <form id="additemform" method="post" action="<?php echo $data['base_url'] .'action/item-add.php' ?>"  enctype="multipart/form-data">
                           ...
                           <div class="position-relative form-group">
                              ...
                              <input name="MaxPrice" id="MaxPrice" type="number" class="form-control"> 
                           </div>
                           <div class="position-relative form-group">
                              <label class="">Min Fiyat</label>
                              <input name="MinPrice" id="MinPrice" type="number" class="form-control"> 
                           </div>
                           <div class="position-relative form-group">
                           ...
                           <div class="position-relative form-group">
                              ...
                              <select name="CategoryID" id="CategoryID"  onchange="get_subcategory()" class="form-control">
                           ...
                           <div class="position-relative form-group">
                              <div>
                                 <div class="custom-checkbox custom-control"><input type="checkbox"  name="featured_item" value="1" id="exampleCustomCheckbox" class="custom-control-input"><label class="custom-control-label" for="exampleCustomCheckbox">Anasayfada Gözüksün
                                    </label>
                                 </div>
                                 <div class="custom-checkbox custom-control"><input type="checkbox" name="state_item" value="1" id="exampleCustomCheckbox2" class="custom-control-input"><label class="custom-control-label" for="exampleCustomCheckbox2">Aktif Olsun
                                    </label>
                                 </div>
                              </div>
                           </div>
